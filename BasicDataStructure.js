...
//setup
let yourArray = ['string', 5, true, 'nope', false]; // Change this line
...
function popShift(arr) {
    let popped = arr.push(); // Change this line
...
// Only change code below this line
arr.splice(1,4); //starts at the first element, removes up to 4 values in the array
// Only change code above this line
console.log(arr);
...
const startIndex = 3;//[12]
const amountToDelete = 1;

numbers.splice(startIndex, amountToDelete, 13, 14); // can be multiple elements add after amountToDelete
...
console.log(copyMachine([true, false, true], 2));
    ...
    // secondArray now equals ['basil', 'cilantro', 'sage', 'rosemary', 'parsley', 'thyme', 'coriander']
    ...
    //We have defined a function spreadOut that returns the variable sentence. Modify the function using the spread operator so that it returns the array ['learning', 'to', 'code', 'is', 'fun'].
      ...
      function spreadOut() {
        let extra = ['to', 'code'];
        let sentence = ['Learing', ...extra, 'is','fun']
        return sentence;
      }
